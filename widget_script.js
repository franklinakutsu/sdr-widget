(function () {
  ...
  style.textContent = [
    ...
    "#sdr-trigger-row{display:flex;align-items:center;gap:8px}",
    ...
    "@media(max-width:480px){#sdr-window{width:calc(100vw - 24px);right:-8px;height:75vh;bottom:72px}#sdr-window.expanded{width:calc(100vw - 8px);height:90vh;right:-8px}#sdr-balloon span{font-size:13px}}"
  ].join('');
